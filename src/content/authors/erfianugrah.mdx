...
tags: ['authors']
author: 作者昵称[ss]
# image: { src: https://www.erfianugrah.com/_astro/Angelo_4_Z1icCsx.avif , alt: Erfi, by lele, positionx: 65%, positiony: 40% }
image: { src: /src/assets/authors/erfianugrah/1.jpg , alt: Erfi, by lele, positionx: 65%, positiony: 40% }
